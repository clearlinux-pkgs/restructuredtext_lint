...
Version  : 0.14.3
Release  : 15
URL      : http://pypi.debian.net/restructuredtext_lint/restructuredtext_lint-0.14.3.tar.gz
Source0  : http://pypi.debian.net/restructuredtext_lint/restructuredtext_lint-0.14.3.tar.gz
...
%prep
%setup -q -n restructuredtext_lint-0.14.3
